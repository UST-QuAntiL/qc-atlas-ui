...
export class ProviderService extends BaseService {
  ...
  createProvider$Response(params: {
      body: ProviderDto
  }): Observable<StrictHttpResponse<{ 'id'?: string, 'name': string, 'accessKey': string, 'secretKey': string, 'links'?: Array<Link> }>> {
    ...
    return this.http.request(rb.build({
      ...
      filter((r: any) => r instanceof HttpResponse),
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<{ 'id'?: string, 'name': string, 'accessKey': string, 'secretKey': string, 'links'?: Array<Link> }>;
      })
    );
  }
  ...
  createProvider(params: {
      body: ProviderDto
  }): Observable<{ 'id'?: string, 'name': string, 'accessKey': string, 'secretKey': string, 'links'?: Array<Link> }> {

    return this.createProvider$Response(params).pipe(
      map((r: StrictHttpResponse<{ 'id'?: string, 'name': string, 'accessKey': string, 'secretKey': string, 'links'?: Array<Link> }>) => r.body as { 'id'?: string, 'name': string, 'accessKey': string, 'secretKey': string, 'links'?: Array<Link> })
    );
  }
