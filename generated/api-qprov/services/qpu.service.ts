...
export class QpuService extends BaseService {
  ...
  /**
   * Path part for operation findByQpuCompKeyBackendName
   */
  static readonly FindByQpuCompKeyBackendNamePath = '/';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findByQpuCompKeyBackendName()` instead.
   *
   * This method doesn't expect any request body.
   */
  findByQpuCompKeyBackendName$Response(params: {
    backendName: string;

  }): Observable<StrictHttpResponse<Qpu>> {

    const rb = new RequestBuilder(this.rootUrl, QpuService.FindByQpuCompKeyBackendNamePath, 'get');
    if (params) {
   ...
   * To access the full response (for headers, for example), `findByQpuCompKeyBackendName$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  findByQpuCompKeyBackendName(params: {
    backendName: string;

  }): Observable<Qpu> {

    return this.findByQpuCompKeyBackendName$Response(params).pipe(
   ...
   */
  static readonly ExecuteSearchQpuGetPath = '/qpus/search/findByQpuCompKey_BackendName';
