...
export class QpuEntityControllerService extends BaseService {
  constructor(
  ...
  getCollectionResourceQpuGet1$Json$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, QpuEntityControllerService.GetCollectionResourceQpuGet1Path, 'get');
    if (params) {
  ...
  postCollectionResourceQpuPost$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, QpuEntityControllerService.PostCollectionResourceQpuPostPath, 'post');
    if (params) {
  ...
  getItemResourceQpuGet$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, QpuEntityControllerService.GetItemResourceQpuGetPath, 'get');
    if (params) {
  ...
  putItemResourceQpuPut$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, QpuEntityControllerService.PutItemResourceQpuPutPath, 'put');
    if (params) {
  ...
  deleteItemResourceQpuDelete$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, QpuEntityControllerService.DeleteItemResourceQpuDeletePath, 'delete');
    if (params) {
  ...
  patchItemResourceQpuPatch$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, QpuEntityControllerService.PatchItemResourceQpuPatchPath, 'patch');
    if (params) {
